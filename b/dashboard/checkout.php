  ...
  <div class="flex-1 py-12">
    <div class="max-w-4xl mx-auto px-4">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="shop.php" class="continue-btn py-3 px-6 rounded-lg text-white font-bold text-center">
          Continue Shopping
        </a>
        <a href="orders.php" class="track-btn py-3 px-6 rounded-lg text-white font-bold text-center">
          Track Your Order
        </a>
      </div>
    </div>
