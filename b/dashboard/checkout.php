    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <p class="ml-2 text-sm font-medium text-gray-900">Cart</p>
        </div>
        ...
        <div class="flex items-center">
          ...
          <p class="ml-2 text-sm font-medium text-gray-900">Information</p>
        </div>
        ...
        <div class="flex items-center">
          ...
          <p class="ml-2 text-sm font-medium text-gray-900">Shipping</p>
        </div>
        ...
        <div class="flex items-center">
          ...
          <p class="ml-2 text-sm font-medium text-gray-600">Payment</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div>
          <div class="bg-white rounded-xl shadow-md p-6 sticky top-24 card-hover">
            ...
            <div class="mt-6">
              ...
              <div class="flex">
                <input type="text" placeholder="Enter promo code" class="flex-1 px-4 py-2 border border-gray-300 rounded-l-lg input-focus">
                <button class="bg-gray-200 hover:bg-gray-300 px-4 rounded-r-lg transition-colors">Apply</button>
              </div>
            </div>
