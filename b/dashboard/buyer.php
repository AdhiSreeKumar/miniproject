...
<nav class="bg-primary text-white px-4 py-3 flex justify-between items-center sticky top-0 z-50 shadow-lg">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" id="productsContainer">
          <?php if (!empty($partsData)): ?>
            <?php foreach ($partsData as $part): ?>
              <div class="product-card bg-white rounded-xl shadow-md p-4 flex flex-col items-start hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer"
                   ...
                   onclick="showProductDetails(
                     ...
                     '<?= addslashes($part['image']) ?>',
                     '<?= addslashes($part['brand']) ?>',
                     '<?= addslashes($part['category']) ?>',
                     '<?= addslashes($part['rating']) ?>',
                     '<?= addslashes($part['price']) ?>',
                     '<?= addslashes($part['warranty']) ?>',
                     '<?= addslashes($part['availability']) ?>',
                     '<?= addslashes($part['description'] ?? 'No description available') ?>'
                   )">
                ...
                <form method="post" action="add_to_cart.php" class="w-full mt-auto" onclick="event.stopPropagation()">
          ...
          <div class="sm:flex sm:items-start">
            <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
              ...
              <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <img id="modalProductImage" src="" alt="" class="w-full h-64 object-contain rounded-md">
                </div>
                <div>
                  <p class="text-sm text-gray-500 mb-2">Brand: <span class="font-medium text-gray-900" id="modalProductBrand"></span></p>
                  <p class="text-sm text-gray-500 mb-2">Category: <span class="font-medium text-gray-900" id="modalProductCategory"></span></p>
                  <div class="flex items-center mb-2">
                    <div class="flex text-yellow-400" id="modalProductRating"></div>
                    <span class="text-sm text-gray-500 ml-1" id="modalRatingValue"></span>
                  </div>
                  <p class="text-green-600 font-bold text-xl mb-2" id="modalProductPrice"></p>
                  <p class="text-sm text-gray-500 mb-2">Warranty: <span class="font-medium text-gray-900" id="modalProductWarranty"></span></p>
                  <p class="text-sm text-gray-500 mb-2">Availability: <span class="font-medium text-gray-900" id="modalProductAvailability"></span></p>
                  <p class="text-sm text-gray-700 mt-4" id="modalProductDescription"></p>
  ...
  <script>
    ...
    function showProductDetails(name, image, brand, category, rating, price, warranty, availability, description) {
      ...
      document.getElementById('modalProductWarranty').textContent = warranty;
      document.getElementById('modalProductAvailability').textContent = availability;
      document.getElementById('modalProductDescription').textContent = description;
      document.getElementById('modalProductId').value = name;
